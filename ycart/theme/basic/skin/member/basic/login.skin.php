...
<div id="mb_login" class="mbskin">
    ...
    <fieldset id="login_fs">
        <legend>회원로그인</legend>
        <input type="text" placeholder="아이디" name="mb_id" id="login_id" required class="frm_input required" size="20" maxLength="20">
        <input type="password" placeholder="비밀번호" name="mb_password" id="login_pw" required class="frm_input required" size="20" maxLength="20">
        <input type="submit" value="로그인" class="btn-large black white-text">
        <p>
      <label>
    ...
    <aside id="login_info">
        <div>
            <a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost" class="btn-small black white-text">아이디 비밀번호 찾기</a>
            <a href="./register.php" class="btn-small blue white-text">회원 가입</a>
        </div>
    </aside>
