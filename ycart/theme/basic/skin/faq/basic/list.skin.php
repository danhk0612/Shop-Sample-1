...
<nav id="bo_cate">
    <ul class="tabs" id="bo_cate_ul">
        ...
        ?>
        <li class="tab col s3"><a href="<?php echo $category_href;?>?fm_id=<?php echo $v['fm_id'];?>" <?php echo $category_option;?> ><?php echo $category_msg.$v['fm_subject'];?></a></li>
        <?php
        }
        ?>
    </ul>
...
<div id="faq_wrap" class="faq_<?php echo $fm_id; ?>">
    ...
    <section id="faq_con">
        <ol>
            ...
            ?>
            <li>
                <h5><a href="#none" onclick="return faq_open(this);"><?php echo conv_content($v['fa_subject'], 1); ?></a></h5>
                <div class="con_inner">
...
<fieldset id="faq_sch">
    ...
    <input type="submit" value="검색" class="btn black white-text">
    </form>
</fieldset>
<!-- } FAQ 끝 -->
...
<?php
if ($admin_href)
    echo '<div class="faq_admin"><a href="'.$admin_href.'" class="btn-small red white-text">FAQ 수정</a></div>';
?>
