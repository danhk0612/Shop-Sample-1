...
<div id="sit_ov_wrap" class="row">
    ...
    <div id="sit_pvi" class="col s7">
        ...
        if($total_count > 0) {
            echo '<ul id="sit_pvi_thumb" class="center-align">';
    ...
    <!-- 상품 요약정보 및 구매 시작 { -->
    <section id="sit_ov" class="col s5">
        <h5 id="sit_title"><?php echo stripslashes($it['it_name']); ?> <span class="sound_only">요약정보 및 구매</span></h5>
        ...
        */
            ...
            <ul id="sit_opt_added">
                <li class="sit_opt_list">
                    ...
                    <div>
                        ...
                        <button type="button" class="sit_qty_plus btn grey darken-1"><i class="material-icons">exposure_plus_1</i></button>
                        <button type="button" class="sit_qty_minus btn grey darken-1"><i class="material-icons">exposure_neg_1</i></button>
                    </div>
                </li>
            </ul>
            <script>
        ...
        <div id="sit_ov_btn" class="center-align">
            <?php if ($is_orderable) { ?>
            <input type="submit" onclick="document.pressed=this.value;" value="구매" id="sit_btn_buy" class="btn grey darken-1">
            <input type="submit" onclick="document.pressed=this.value;" value="장바구니" id="sit_btn_cart" class="btn grey darken-1">
            <?php } ?>
            <?php if(!$is_orderable && $it['it_soldout'] && $it['it_stock_sms']) { ?>
            <a href="javascript:popup_stocksms('<?php echo $it['it_id']; ?>');" id="sit_btn_buy">재입고알림</a>
            <?php } ?>
            <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" id="sit_btn_wish" class="btn grey darken-1 white-text">찜하기</a>
