...
<aside id="stv">
    <div id="stv_list">
        ...
        <ul id="stv_nb">
            <li><a href="<?php echo G5_SHOP_URL; ?>/cart.php"><i class="material-icons">shopping_cart</i></a></li>
            <li><a href="<?php echo G5_SHOP_URL; ?>/wishlist.php"><i class="material-icons">favorite</i></a></li>
            <li><a href="<?php echo G5_SHOP_URL; ?>/orderinquiry.php"><i class="material-icons">format_align_justify</i></a></li>
            <li><a href="#"><i class="material-icons">keyboard_capslock</i></a></li>
        </ul>
    </div>
</aside>
