...
?>
    ...
    <div id="sod_bsk">
            ...
            <div class="">
                <table class="centered">
                    <thead>
                        <tr>
                            <th>
                                <input type="checkbox" class="filled-in" name="ct_all" value="1" id="ct_all" checked="checked">
                            </th>
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
            ...
            if($it_options) {
                $mod_options = '<div class="sod_option_btn"><button type="button" class="mod_options btn black white-text">옵션 변경</button></div>';
                $it_name .= '<div class="">'.$it_options.'</div>';
            }
        ...
        ?>
                            ...
                            <tr>
                                ...
                                <td class="td_numbig">
                                    <span id="sell_price_<?php echo $i; ?>">
    ...
    ?>
                <div id="sod_bsk_tot">
                    <p>배송비 :
                        <strong>
                            <?php echo number_format($send_cost); ?> 원</strong>
                    </p>
                    <p>총 가격 (포인트) :
                        <strong>
                ...
                <div id="sod_bsk_act">
                    <?php if ($i == 0) { ?>
                    <a href="<?php echo G5_SHOP_URL; ?>/" class="btn black white-text">쇼핑 계속하기</a>
                    <?php } else { ?>
                    <input type="hidden" name="url" value="./orderform.php">
                    <input type="hidden" name="records" value="<?php echo $i; ?>">
                    <input type="hidden" name="act" value="">
                    <a href="<?php echo G5_SHOP_URL; ?>/list.php?ca_id=<?php echo $continue_ca_id; ?>" class="btn black white-text">쇼핑 계속하기</a>
                    <button type="button" onclick="return form_check('buy');" class="btn blue white-text">주문하기</button>
                    <button type="button" onclick="return form_check('seldelete');" class="btn red white-text">선택삭제</button>
                    <button type="button" onclick="return form_check('alldelete');" class="btn red white-text">비우기</button>
                    <?php if ($naverpay_button_js) { ?>
                    <div class="cart-naverpay">
