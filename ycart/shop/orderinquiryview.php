    ...
    <div id="sod_fin">
        ...
        ?>
                <div class="">
                    <table class="centered">
                        <thead>
                            <tr>
                                <th scope="col" colspan="2" id="th_itopt">상품 정보</th>
            ...
            ?>
                                <tr>
                                    <td rowspan="<?php echo $rowspan; ?>" class="td_imgsmall">
                                        <?php echo $image; ?>
                                    </td>
                                    <td headers="th_itname" colspan="7">
                                ...
                                <?php } ?>
                                <tr>
                                    <td headers="th_itopt" width="400px" style="text-align:left;">
                                        <?php echo get_text($opt['ct_option']); ?>
                                    </td>
                                    <td headers="th_itqty" class="td_mngsmall">
                                        <?php echo number_format($opt['ct_qty']); ?>
                                    </td>
                                    <td headers="th_itprice" class="td_numbig">
                                        <?php echo number_format($opt_price); ?>
                                    </td>
                                    <td headers="th_itsum" class="td_numbig">
                                        <?php echo number_format($sell_price); ?>
                                    </td>
                                    <td headers="th_itpt" class="td_num">
                                        <?php echo number_format($point); ?>
                                    </td>
                                    <td headers="th_itpt" class="td_dvr">
                                        <?php echo $ct_send_cost; ?>
                                    </td>
                                    <td headers="th_itst" class="td_mngsmall">
                                        <?php 
                                            echo '<a class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="';
                                            switch ($opt['ct_status']) {
                                                case '주문'  : echo '주문이 접수되었습니다.'; break;
                                                case '입금'  : echo '입금(결제)이 완료 되었습니다.'; break;
                                                case '준비'  : echo '상품 준비 중입니다.'; break;
                                                case '배송'  : echo '상품 배송 중입니다.'; break;
                                                case '완료'  : echo '주문이 접수되었습니다.'; break;
                                                case '취소'  : echo '주문이 취소되었습니다.'; break;
                                                default   : break;
                                            }                                            
                                            echo '">'.$opt['ct_status'].'</a>';
                                        ?>
                                    </td>
                                </tr>
                                <?php
        ...
        <div id="sod_bsk_tot">
            <p>
                주문총액 :
                <strong>
                    <?php echo number_format($od['od_cart_price']); ?> 원</strong>
            </p>
            ...
            <p>
                개별 쿠폰할인 :
                <strong>
                    <?php echo number_format($od['od_cart_coupon']); ?> 원</strong>
            </p>
            <?php } ?>
            ...
            <p>
                전체 쿠폰할인 :
                <strong>
                    <?php echo number_format($od['od_coupon']); ?> 원</strong>
            </p>
            <?php } ?>
            ...
            <p>
                배송비 :
                <strong>
                    <?php echo number_format($od['od_send_cost']); ?> 원</strong>
            </p>
            <?php } ?>
            ...
            <p>
                배송비 쿠폰할인 :
                <strong>
                    <?php echo number_format($od['od_send_coupon']); ?> 원</strong>
            </p>
            <?php } ?>
            ...
            <p>
                추가배송비 :
                <strong>
                    <?php echo number_format($od['od_send_cost2']); ?> 원</strong>
            </p>
            <?php } ?>
            ...
            <p>
                취소금액 :
                <strong>
                    <?php echo number_format($od['od_cancel_price']); ?> 원</strong>
            </p>
            <?php } ?>
            ...
            <p>
                총계 :
                <strong>
                    <?php echo number_format($tot_price); ?> 원</strong>
            </p>
            <p>
                포인트 :
                <strong>
                    <?php echo number_format($tot_point); ?> 점</strong>
            </p>
        </div>
        ...
        ?>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo ($easy_pay_name ? $easy_pay_name.'('.$od['od_settle_case'].')' : check_pay_name_replace($od['od_settle_case']) ); ?>
                                    </td>
                                </tr>
                                <tr>
                ...
                ?>
                    ...
                    {
                    ?>
                                                                            <a href="javascript:;" onclick="window.open('<?php echo G5_SHOP_URL; ?>/taxsave.php?od_id=<?php echo $od_id; ?>', 'taxsave', 'width=550,height=400,scrollbars=1,menus=0');"
                                                                                class="btn_frmline">현금영수증을 발급하시려면 클릭하십시오.</a>
                                                                            <?php } ?>
                                                                </td>
                                                            </tr>
                                                            <?php
                ...
                ?>
                                        <tr>
                                            <td class="empty_table">배송정보가 입력되지 않았습니다.</td>
                                        </tr>
                                        <?php
                }
                ?>
        ...
        if ($cancel_price == 0) {
            if ($custom_cancel) {
        ?>
                    <button class="btn red white-text" type="button" onclick="document.getElementById('sod_fin_cancelfrm').style.display='block';">주문 취소하기</button>
                    ...
                    <div id="sod_fin_cancelfrm">
                        <form method="post" action="./orderinquirycancel.php" onsubmit="return fcancel_check(this);">
                            ...
                            <input placeholder="취소 사유를 입력해 주세요." type="text" name="cancel_memo" id="cancel_memo" required class="frm_input required" size="40" maxlength="100">
                            <input type="submit" value="확인" class="btn black white-text">
