...
<div id="sod_ws">
    ...
    <div class="">
        ...
        <tr>
            ...
            <td width="400px" style="text-align:left;"><a href="./item.php?it_id=<?php echo $row['it_id']; ?>"><?php echo stripslashes($row['it_name']); ?></a></td>
        ...
        if ($i == 0)
            echo '<tr><td colspan="5" class="empty_table">찜한 상품이 없습니다.</td></tr>';
        ?>
        </tr>
        </tbody>
        </table>
    ...
    <div id="sod_ws_act">
        <button type="submit" class="btn black white-text" onclick="return fwishlist_check(document.fwishlist,'');">장바구니 담기</button>
        <button type="submit" class="btn blue white-text" onclick="return fwishlist_check(document.fwishlist,'direct_buy');">주문하기</button>
    </div>
    </form>
</div>
