...
<div id="syt">
    ...
    // 상단 HTML
    echo '<div id="syt_hhtml">'.conv_content($ca['ca_head_html'], 1).'</div>';
    ...
    $error = '<p class="syt_noitem">등록된 상품이 없습니다.</p>';
    ...
    {
        echo '<div class="syt_nofile">'.str_replace(G5_PATH.'/', '', $skin_file).' 파일을 찾을 수 없습니다.<br>관리자에게 알려주시면 감사하겠습니다.</div>';
    }
    ?>
    ...
    <?php
    // 하단 HTML
    echo '<div id="syt_thtml">'.conv_content($ca['ca_tail_html'], 1).'</div>';
