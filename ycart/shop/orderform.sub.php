...
<div id="sod_frm">
    ...
    <div class="tbl_head01 tbl_wrap">
        <table id="sod_list" class="centered">
        <thead>
        <tr>
        ...
        <tr>
            <td colspan="8">상품가격 : <?php echo number_format($tot_sell_price); ?> 원&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;  
            배송비 : <?php echo number_format($send_cost); ?> 원&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
            총 가격 : <?php $tot_price = $tot_sell_price + $send_cost; echo number_format($tot_price); ?> 원</td>
        </tr>
        </tbody>
        </table>
    </div>
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="black white-text btn-small" onclick="win_zip('forderform', 'od_zip', 'od_addr1', 'od_addr2', 'od_addr3', 'od_addr_jibeon');">주소 검색</button><br>
                    ...
                    <br>
                    <input type="text" name="od_addr3" value="<?php echo get_text($member['mb_addr3']) ?>" id="od_addr3" class="frm_input frm_address" size="60" readonly="readonly">
    ...
    <section id="sod_frm_taker">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            if($is_member) {
                ...
                $addr_list .='<a href="'.G5_SHOP_URL.'/orderaddress.php" id="order_address" class="black white-text btn-small">배송지목록</a>';
            } else {
                // 주문자와 동일
            ...
            <tr>
                ...
                <td id="sod_frm_addr">
                    ...
                    <button type="button" class=" black white-text btn-small" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');">주소 검색</button><br>
            ...
            <tr>
                <th scope="row"><label for="od_memo">남길말</label></th>
    ...
    <section id="sod_frm_pay">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" id="od_coupon_btn" class="black white-text btn-small">쿠폰적용</button>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" id="sc_coupon_btn" class="black white-text btn-small">쿠폰적용</button>
                </td>
            </tr>
            <tr>
        ...
        if ($default['de_bank_use']) {
            ...
            echo '<p>'.$bank_account.'</p>';
            echo '<input type="hidden" name="od_deposit_name" id="od_deposit_name" class="frm_input" size="10" maxlength="20" style="display:none">';
            echo '</div>';
        }
...
$(function() {
    ...
    $(document).on("click", ".cp_apply", function() {
        ...
        if(!$cp_row_el.find(".cp_cancel").size())
            $cp_btn_el.after("<button type=\"button\" class=\"cp_cancel red white-text btn-small\">취소</button>");
    });
    ...
    $(document).on("click", ".od_cp_apply", function() {
        ...
        if(!$("#od_coupon_cancel").size())
            $("#od_coupon_btn").after("<button type=\"button\" id=\"od_coupon_cancel\" class=\"red white-text btn-small\">쿠폰취소</button>");
    });
