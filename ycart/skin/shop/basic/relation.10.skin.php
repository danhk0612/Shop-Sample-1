...
for ($i=1; $row=sql_fetch_array($result); $i++) {
    ...
    if ($i == 1) {
        if ($this->css) {
            ...
            echo "<ul class=\"syt scr_10\">\n";
        }
    }

    echo "<li class=\"syt_li {$syt_last}\" style=\"width:{$this->img_width}px\">\n";
    ...
    if ($this->view_it_id) {
        echo "<div class=\"syt_id\">&lt;".stripslashes($row['it_id'])."&gt;</div>\n";
    }
    ...
    if ($this->view_it_basic && $row['it_basic']) {
        echo "<div class=\"syt_basic\">".stripslashes($row['it_basic'])."</div>\n";
    }
    ...
    if ($this->view_sns) {
        ...
        echo "<div class=\"syt_sns\" style=\"top:{$sns_top}px\">";
